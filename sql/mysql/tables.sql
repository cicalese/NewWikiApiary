...
CREATE TABLE /*_*/w8y_scrape_records (
  ...
  w8y_sr_api_url BLOB NOT NULL,
  w8y_sr_timestamp BINARY(14) NOT NULL,
  w8y_sr_is_alive TINYINT(1) NOT NULL,
  w8y_sr_mw_version VARBINARY(255) NOT NULL,
...
CREATE TABLE /*_*/w8y_extensions (
  ...
  w8y_ex_name VARBINARY(255) NOT NULL,
  w8y_ex_version VARBINARY(255) NOT NULL,
...
CREATE TABLE /*_*/w8y_skins (
  ...
  w8y_sk_name VARBINARY(255) NOT NULL,
  w8y_sk_version VARBINARY(255) NOT NULL,
